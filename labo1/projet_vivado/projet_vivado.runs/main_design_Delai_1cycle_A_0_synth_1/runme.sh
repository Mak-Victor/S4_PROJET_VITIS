...
HD_PWD='C:/Users/victo/OneDrive/Bureau/ProjetCode/labo1/projet_vivado/projet_vivado.runs/main_design_Delai_1cycle_A_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_Delai_1cycle_A_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_Delai_1cycle_A_0.tcl
